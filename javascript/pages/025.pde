...
/* @pjs preload="./images/001.jpg,./images/002.jpg,./images/003.jpg,./images/004.jpg"; */
void setImage(int image) {
  switch(image) {
  case 1:
    img = loadImage("./images/001.jpg");
    break;

  case 2:
    img = loadImage("./images/002.jpg");
    break;

  case 3:
    img = loadImage("./images/003.jpg");
    break;

  case 4:
    img = loadImage("./images/004.jpg");
    break;
  }
