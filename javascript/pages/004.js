...
$(document).ready(function() {
    ...
    // var text = document.getElementById('textsource').innerHTML;
    ...
    if (bg) {
        bg.src = "./background_images/o-superman_o_GIFSoup.com.gif";
        }

    // typeText();

    $('#targettext')[0].innerHTML = text.replace(/ /gi, '&nbsp;').replace(/\n/gi, '<br />');
    $('#targettext').scrambledWriter2();
