// original code from http://onehackoranother.com/projects/jquery/jquery-grab-bag/text-effects.html
...
(function($) {
    ...
    $.fn.scrambledWriter = function() {
        ...
        this.each(function() {
            ...
            // $ele.html() contains all of the line breaks etc.
        ...
        this.each(function() {
            ...
            // $ele.html() contains all of the line breaks etc.
            // only trouble is, it parses &nbsp; and <br /> as individual chars
            // so the page-length goes crazy although the block of text looks nice
            
            $ele.html('');

            var timer = setInterval(function() {
                $ele.html(str.substring(0, progress) + str.substring(progress, str.length).replace(replace, random));
                progress += inc;
                if (progress >= str.length + inc) clearInterval(timer);
            }, 100);
        });
